			...
			<div className="flex items-center space-x-4">
				...
				<div>
					...
					<p className="text-sm text-muted-foreground">
						Guarantor #418003 | Testaranth Balamicroda
					</p>
			...
			<div className="max-w-7xl mx-auto flex">
				...
				<div className="flex-grow max-w-4xl mr-8">
					...
					<p className="text-sm text-muted-foreground mb-8">
						As a result of your treatment at Tampa General Hospital (Hospital
						services) and USF Health (Physician services), as well as other
						hospital-based physician providers such as the ER Physician,
						Radiologist that interprets your X-Ray, Pathologist that interprets
						your Lab tests, or an Anesthesiologist.
					</p>
					...
					<div className="space-y-4 text-sm">
						<div>
							...
							<p className="text-muted-foreground">
								The guarantor is the person responsible for paying the balance
								of an account.
							</p>
						</div>
						<div>
							...
							<p className="text-muted-foreground">
								If you can't pay your whole bill at once, you may be able to set
								up a payment plan. This lets you automatically pay a small
								amount each month.
							</p>
						</div>
						<div>
							<h4 className="font-semibold mb-1">
								USF COVID19 Financial Assistance
							</h4>
							<p className="text-muted-foreground">
								If you need help paying your USF medical bill, we're here for
								you...
							</p>
						</div>
						<div className="border-t pt-3 mt-3">
							<h4 className="font-semibold mb-1 text-blue-600">
								How else can I receive my billing information?
							</h4>
							<p className="text-muted-foreground">
								You will still have the ability to receive billing
								communications online when possible...
							</p>
						</div>
					</div>
				</Card>
