...
export const ImagingVisitView: React.FC = () => {
    ...
    const [scheduleMoreThanOne, setScheduleMoreThanOne] = useState<boolean | null>(null);
    ...
    return (
        <div className="p-6 md:p-10 lg:p-12 bg-white flex-grow">
            <div className="max-w-6xl mx-auto">
                ...
                <Card className="p-8 shadow-lg border-gray-100 min-h-[300px] flex flex-col justify-between">
                    <div>
                        ...
                        <div className="flex justify-between items-center py-4 border-y border-gray-200">
                            ...
                            <div className="flex space-x-2">
                                <Button 
                                    ...
                                    className={scheduleMoreThanOne === true ? 'bg-blue-800 hover:bg-blue-700 text-white' : 'text-gray-700 hover:bg-gray-100'}
                                >
                                    Yes
                                </Button>
                                <Button 
                                    variant={scheduleMoreThanOne === false ? 'default' : 'outline'}
                                    onClick={() => setScheduleMoreThanOne(false)}
                                    className={scheduleMoreThanOne === false ? 'bg-blue-800 hover:bg-blue-700 text-white' : 'text-gray-700 hover:bg-gray-100'}
                                >
                                    No
                                </Button>
                            </div>
